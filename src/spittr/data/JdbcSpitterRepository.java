...
// where id = ?",
// spitter.getUsername(), spitter.getPassword(), spitter.getFirstName(),
// spitter.getLastName(),
// spitter.getId());
// }
//
...
// SimpleJdbcInsert(jdbcTemplate).withTableName("spitter");
...
// "select id, username, password, firstname, lastname from spitter where
// username = ?",
